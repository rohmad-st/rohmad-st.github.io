export const profile = {
  ...
  summary: "Hi, I'm Rohmad Sasmito<br><strong>Frontend Developer | iOS Developer | Fullstack Developer</strong>"
...
//           image: 'https://res.cloudinary.com/rohmadst/image/upload/v1528022531/projects/qiscus_sdkweb.png',
//           title: 'QISCUS SDK WEB',
//           summary: 'Is SDK (Software Development Kit) provide CHAT UI that has been designed and optimized for easy customization. So client can add chat to their application with easy setup.',
//           description: 'Qiscus SDK Web is built on the both of VanillaJS and VueJS, it has separating modules that known as SDK Core and SDK UI. Frontend team had focused on logic in client side, developed features request, and make sure bug free.',
//           technologies: ['VueJS', 'VanillaJS', 'MQTT', 'CSS (Stylus)', 'HTML (Jade/Pug)'],
//           url: 'https://qiscus.com/documentation/web/latest',
//         },
//         {
...
//           side: 'right',
//           image: './static/images/kiwari.png',
//           title: 'APPLICATION FINGERPRINT DATA COLLECTION',
//           summary: 'ini description of the application',
//           description: '',
//           technologies: ['Javascript', 'CSS'],
//           url: 'https://rohmad.herokuapp.com/portfolio'
